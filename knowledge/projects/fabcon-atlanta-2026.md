...
## Overview
Microsoft Fabric Community Conference (FABCON) attendance in Atlanta.
...
| **Type** | Microsoft Fabric Conference |
...
FBGFFPBOGOWTE
```
Use this code when registering a second attendee.

## Important Deadlines

| Deadline | Date |
|----------|------|
| **Room Block Deadline** | February 22, 2026 |
...
- **Cannot transfer** - European event is produced by a different show organizer
- Can only transfer to other TechCon events (same organizer)
- Atlanta March 2026 dates confirmed: **March 8-12**

**Options**:
1. Attend Atlanta as planned
2. Transfer to another TechCon event (not Barcelona)
3. Forfeit registration

**New Plan**: Still considering FabCon Barcelona (October 2026) - but need separate registration
- Nandan Hegde to attend Barcelona
- Jake to join him there
- Nandan visiting UK in October as part of trip

## Original Attendees (March - decision pending)
- Jake (confirmed but reconsidering)
- Second person TBD
...
- Networking with Fabric community
