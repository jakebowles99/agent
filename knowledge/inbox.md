...
### Changes This Window
- **Emails:** 2 new (Re: Doc Extraction Webpage Requirements; Re: Custom Import Template and Auth)
...
- **Teams Channels:** 0 messages in 0 channels
- **Transcripts:** 0 new
- **People Profiles:** 18 processed (0 created, 18 updated)
- **Calendar:** 10 events on calendar
- **Time Tracking:** none

### Action Items Detected
- [ ] Midwich Squad: confirm conclusion on Yaz Qaraqeshs attached item.
- [ ] Midwich Squad: confirm whether Application Insights needs deploying for SQL in addition to connected audits to Log Analytics.
- [ ] Tayo Eletu-Odibo: send SOW for other CIT today.
...
### Changes This Window
- **Emails:** 1 new
- **Teams Chats:** 42 messages across 9 conversations
- **Teams Channels:** 0 messages in 0 channels
- **Transcripts:** 0 new
- **People Profiles:** 18 processed (1 created, 17 updated)
- **Calendar:** 10 events on calendar (current: "Product Catchup" 10:3010:55 UTC; also "Euroleague - final reviews" 10:3011:00 UTC)
- **Time Tracking:** none

### Action Items Detected
- [ ] Midwich Squad: investigate PO app UAT order **100120** showing a future created date; check API payload / app passing order date as current date; confirm Ellas permissions.
- [ ] 17C User Accounts: determine where password reset emails are being sent (Synapx vs 17c) and how to access them without creds.
- [ ] Standup - LCP Doc Extraction: provide a runthrough demo in standup; investigate missing PDF extraction for Email Body (144A) + Preliminary PDF + V3 combination.
- [ ] Standup - LCP Doc Extraction: clarify whether ContractType should be constrained to fixed dropdown categories.
- [ ] Standup - LCP Doc Extraction: (design quick win) improve selected/highlighted font colour contrast.
- [ ] Kushagra Shukla: schedule time to discuss vibe coding prerequisites and how to get started.
- [ ] Charlotte Price: clarify what name refers to.
- [ ] Marketing Requests: follow up on Construction Data Automation with Microsoft Fabric | Mount Anvil Case Study.
- [ ] Capital H&B Handover: follow up removal of Conditional Access restriction (UK device-only) to allow access from AVD/UK IPs; currently blocking subscription and 1Password setup.
