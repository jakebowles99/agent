...
### Changes Today
- **Emails:** 50 new (Security recommendation: Help protect your VMs in any environment; Fabric Analyst in a Day (FAIAD); February Replit Product Updates; Re: Post Event Call: Synapx - CDIAD - Feb 20th; Signature requested on "WA COMMUNICATIONS_SOW004_Support (T&M)_19 February 2026")
- **Teams Chats:** 4 messages across 2 conversations
- **Teams Channels:** 2 messages in 2 channels
- **Transcripts:** 0 new
- **People Profiles:** 0 updated
...
- [ ] LCP Doc Extraction: Charlie to customise manifest and confirm whether issue is resolved.
- [ ] Product: Rahul to confirm access to Foundry endpoints; request LLM API keys from Jake if needed.
- [ ] Compass CHC: Kia to confirm shared inbox routing for additional services requests; Tarun to notify before email testing, fix DOB format (UK), update case timeline, integrate actions required with CMS, add UI feedback for notifications & preferences, align brand colours; Tarun/Charlie to sync payment status CMS22Zoho; Charlie/Munni to set Lewis demo time; Narayan to enable bulk approval status field + inactive dropdown + org/folder field and update SharePoint flow; Charlie to finish QA + set UAT date + written status update; Rachel/Andy to validate written extraction requirements and confirm back.
