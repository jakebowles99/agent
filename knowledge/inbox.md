...
### Changes This Window
- **Emails:** 4 new
- **Teams Chats:** 18 messages across 7 conversations
- **Teams Channels:** 0 messages in 0 channels
- **Transcripts:** 0 new
- **People Profiles:** 0
...
### Action Items Detected
- [ ] Review the 4 new emails and action any requests.
...
### Changes This Window
- **Emails:** 1 new (subjects: unknown)
- **Teams Chats:** 32 messages across 8 conversations
- **Teams Channels:** 0 messages in 0 channels
- **Transcripts:** 0 new
- **People Profiles:** 0
...
### Action Items Detected
- [ ] Confirm/notify once the project is created in Harvest (Capital H&B Handover).
- [ ] Resolve Harvest setup for Capital Hair & Beauty SOW T&M vs Fixed separation (Charlotte/Andrew).
- [ ] Assign someone to manage registrations (Synapx Leadership Team).
- [ ] Andrew to speak to Fraser today re: what to do with paid Azure resources.
- [ ] Add/review LCP doc extraction bugs in the shared sheet; investigate crashes/long runtimes on large PDFs.
- [ ] Schedule next Prod push and code review timing for PO/SO apps (with Yaz).
- [ ] Ask Charlotte to add an additional PMO tag under Data and AI (Nandan request).
- [ ] Continue sourcing for mid-level role; consider less-experienced profiles if assignment performance is strong.

### Files Updated
- knowledge/emails/2026-02-10.md
- knowledge/teams/2026-02-10/capital-h-b-handover.md
- knowledge/teams/2026-02-10/charlotte-price.md
- knowledge/teams/2026-02-10/lcp-finance-doc-extraction-handover.md
- knowledge/teams/2026-02-10/synapx-leadership-team.md
- knowledge/teams/2026-02-10/azure-admin.md
...
### Changes This Window
- **Emails:** 0 new
- **Teams Chats:** 13 messages across 4 conversations
