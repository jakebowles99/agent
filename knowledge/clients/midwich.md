...
## Company Overview
Midwich Group is a leading specialist distributor of technology solutions, serving trade customers across EMEA and Asia Pacific.

## Subsidiaries
- **Nimans** - UK-based telecommunications distributor

## Key Contacts

| Name | Role | Notes |
|------|------|-------|
| [Joe Thompson](../people/joe-thompson.md) | Chief Transformation Officer | Primary contact for Slipstream project |
...
- **2026-02-20 01:10:** Email thread re: Boomi & Slipstream master file formats and HLD to align approach.
- **2026-02-20 01:10:** Weekly project progress email sent (in Yaz's absence).
- **2026-02-20 01:10:** Midwich squad daily standup (no transcript/insights available).
...
- **2026-02-20 04:08:** Email thread re: “Boomi & Slipstream - K&S” (Jake to Jon Allen / Joe Thompson): Jake to send required master-file formats and an HLD for approach.
- **2026-02-20 04:08:** Midwich weekly project progress email sent to Joe Thompson (covering for Yaz).
