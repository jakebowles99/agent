...
## Contact
- Primary technical contact for LemonEdge integration project

## Projects
- [LemonEdge Fabric Integration POC](../projects/leadenhall-lemonedge.md)

## Working Relationship
- Hands-on operational contact
- Coordinating between Synapx and LemonEdge vendor

## Technical Context
- Working on FX rates import from LemonEdge to Fabric
- Aware of pagination issues and negative rate problems

## Recent Activity (Feb 6, 2026)

### FX Rates Decision
- Confirmed: **exclude negative rates from Fabric data going forward**
...
- **2026-02-11 15:55:** Asked whether Chrysalis exchange rates are being pushed via API to LemonEdge.
- **2026-02-11 14:08:** Asked about exchange rates being pushed via API; referenced in Teams chat as point of contact for scope/approvals.
- **2026-02-11 13:55:** Asked about Chrysalis exchange rates being pushed via API to LemonEdge; discussed potential call with Nandan about data sources and FX rate scope.
- **2026-02-11 13:25:** Asked about exchange rates pushed via API to LemonEdge; suggested adding out-of-scope item to SOW and offered call.
...
- **2026-02-11 11:55:** Asked whether Chrysalis ExchangeRate data is being pushed via API to LemonEdge; discussed FX rate scope.
- **2026-02-11 11:26:** Asked about ExchangeRate table rates being pushed via API; in Teams chat, Jake responded about shared mailbox not hooked to Fabric and SOW to be sent.
...
- **2026-02-10 03:05:** Attendee for canceled LCP Doc Extraction standup on 2026-02-10
- **2026-02-10 02:39:** External attendee on (canceled) LCP Doc Extraction standup (2026-02-10).
- **2026-02-10 02:28:** External attendee for LCP doc extraction standup (canceled) (2026-02-10).
- **2026-02-10 02:02:** Included as attendee for (canceled) LCP doc extraction standup on 2026-02-10.
